<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section class="mb-6 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-cyan-900 px-6 py-7 text-white shadow-lg">
                <div class="grid gap-6 lg:grid-cols-[2fr,1fr] lg:items-center">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-200 max-w-2xl">Use this dashboard to monitor sales health, inventory risk, and pending actions before they become bottlenecks.</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-5 mb-7">
                ...
                <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                    ...
                    <p class="text-3xl font-bold text-slate-900">{{ $data['total_users'] }} / {{ $data['total_customers'] }}</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-7">
                <a href="{{ route('admin.users.index') }}" class="group rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-0.5 hover:shadow-md">
                ...
                <a href="{{ route('admin.products.index') }}" class="group rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-0.5 hover:shadow-md">
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Admin Action</p>
                ...
                <a href="{{ route('admin.reports.sales') }}" class="group rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-0.5 hover:shadow-md">
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Admin Action</p>
                ...
                <a href="{{ route('admin.activity-logs.index') }}" class="group rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-0.5 hover:shadow-md">
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Admin Action</p>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="{{ route('admin.sales.index') }}" class="text-sm font-medium text-cyan-700 hover:text-cyan-800">View all</a>
                    </div>
                ...
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="{{ route('admin.reports.stock') }}" class="text-sm font-medium text-cyan-700 hover:text-cyan-800">Stock report</a>
                    </div>
                    ...
                    <div class="space-y-3">
                        @forelse ($lowStockProducts as $product)
                            <div class="flex items-center justify-between rounded-xl border border-slate-200 p-3">
                                ...
                                <span class="px-2 py-1 rounded-full text-xs font-semibold {{ $product->stock_quantity <= 0 ? 'bg-rose-100 text-rose-700' : 'bg-amber-100 text-amber-700' }}">
