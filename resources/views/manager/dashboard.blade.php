<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section
                class="mb-6 rounded-2xl bg-gradient-to-r from-teal-800 via-cyan-800 to-slate-900 px-6 py-7 text-white shadow-lg">
                <div class="grid gap-6 lg:grid-cols-[2fr,1fr] lg:items-center">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-cyan-100 max-w-2xl">Track sales pace, monitor inventory pressure,
                            and jump directly to reports or purchasing actions.</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-7">
                ...
                <a href="{{ route('manager.activity-logs.index') }}"
                    class="group rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-0.5 hover:shadow-md">
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Operations Action</p>
                ...
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-5 text-center">
                        ...
                        <div class="rounded-xl bg-slate-50 p-3">
                            ...
                            <p class="text-xl font-bold text-slate-900">${{ number_format($data['month_expenses'], 2) }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        @forelse ($lowStockProducts as $product)
                            <div class="flex items-center justify-between rounded-xl border border-slate-200 p-3">
                                ...
                                <span
                                    class="text-xs font-semibold {{ $product->stock_quantity <= 0 ? 'text-rose-600' : 'text-amber-600' }}">
