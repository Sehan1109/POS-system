<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Launch POS Call to Action -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-8 text-center mt-8">
                <div class="text-6xl mb-4">🛒</div>
                <h2 class="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Ready to sell?</h2>
                <p class="text-gray-500 dark:text-gray-400 mb-6">Open the cashier terminal to start processing transactions.</p>
                <a href="{{ route('pos.index') }}" class="inline-flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 shadow-sm transition">
                    Launch POS Terminal
                </a>
            </div>
